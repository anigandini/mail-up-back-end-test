<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('price_sale') }}
            {{ Form::text('price_sale', $product->price_sale, ['class' => 'form-control' . ($errors->has('price_sale') ? ' is-invalid' : ''), 'placeholder' => 'Price Sale']) }}
            {!! $errors->first('price_sale', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('category') }}
